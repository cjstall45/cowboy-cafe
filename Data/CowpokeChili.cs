/*
* Author: Dr. Bean
* Modified By: Charlie Stallbaumer
* Class name: CowpokeChili
* Purposes: to create a  class representing the Cowpoke Chili entree
*/
using System;
...
namespace CowboyCafe.Data
{
    ...
    public class CowpokeChili : Entree
    {
        ...
        public bool GreenOnions
        {
            ...
            set { greenOnions = value; NotifyOfPropertyChanged("GreenOnions"); }
        }
        ...
        public bool TortillaStrips
        {
            ...
            set { tortillaStrips = value; NotifyOfPropertyChanged("TortillaStrips"); }
        }
